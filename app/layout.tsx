...
export const metadata: Metadata = {
  ...
  description: 'Alejandro Esteban Gonzalez Gatica is a full-stack and gamedeveloper with 3 years of experience.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${comfortaa.className} relative pt-28 sm:pt-36 bg-gray-900 text-gray-50 text-opacity-90`}
      >
